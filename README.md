...
<div align="left">
    <p>
        query-lang is the FEAT-tier crate: A query-based incremental compilation framework (salsa/rust-analyzer model). Part of the -lang language-construction family; see _strategy/LANG_COLLECTION.md for the master plan.
    </p>
    <br>
    <hr>
    <p>
